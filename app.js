...
app.post('/',function(req,res){
    ...
    var query="insert into student(rollno,name,sub1,sub2,sub3,total,per,max,min,resl)values('"+rollno+"','"+name+"','"+sub1+"','"+sub2+"','"+sub3+"','"+total+"','"+per+"','"+max+"','"+min+"','"+resl+"')";
...
app.post('/update/:id', function (req, res) {
    ...
    var query="update student set rollno= '"+ rollno +"',name='" + name + "',sub1='" + sub1 + "',sub2='" + sub2 + "',sub3='" + sub3 + "',total='" + total + "',per='" + per + "',max='" + max + "',min='" + min + "',resl='"+ resl+"' where id="+id; 
